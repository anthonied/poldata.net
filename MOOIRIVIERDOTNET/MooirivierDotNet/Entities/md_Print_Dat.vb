...
Public Class md_Print_Dat
    ...
    Private m_VOERTUIE As String
    Private m_EISE As String
    Private m_polisno As String
    Private m_G_BONUS As String
    Private m_AREA As String
    Private m_betwyse As String
    'Linkie 01/07/2013 - maak tipes reg volgens databasis
...
Public Property PakketItem2() As String
    ...
    <DataObjectField(False, False, False)> _
    Public Property akketItem3() As Decimal
        Get
            Return m_PakketItem3
        End Get
        Set(ByVal value As Decimal)
...
Public Property MPREMIE() As String
    ...
    <DataObjectField(False, False, False)> _
Public Property VOERTUIE() As String
        Get
            Return m_VOERTUIE
        End Get
        Set(ByVal value As String)
    ...
    <DataObjectField(False, False, False)> _
Public Property EISE() As String
        Get
            Return m_EISE
        End Get
        Set(ByVal value As String)
...
Public Property Afsluit_dat() As String
    ...
    'Linkie 01/07/2013 - maak tipes reg volgens databasis
    <DataObjectField(False, False, False)> _
    Public Property careassist() As Double
        Get
            Return m_careassist
        End Get
        Set(ByVal value As Double)
  ...
  Public Property mmkode() As String
    ...
    <DataObjectField(False, False, False)> _
  Public Property tipevoert() As Integer
        Get
            Return m_tipevoert
        End Get
    ...
    <DataObjectField(False, False, False)> _
Public Property bemarker() As Date
        Get
            Return m_bemarker
        End Get
        Set(ByVal value As Date)
